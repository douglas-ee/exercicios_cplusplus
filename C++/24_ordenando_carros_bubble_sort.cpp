...
void ordena(Carro car[], int tam)
{
	...
	for(int i = tam; i >= 0; i--)
	{
		for(int j = 1; j <= i; j++)
		{
			//O STRCMP � uma funcao da biblioteca <string.h> responsavel por comparar strings
...
int main(int argc, char *argv[])
{
	...
	//La�o de repeti��o responsavel pela inclus�o dos dados
	while(true)
	{
		//Atribui��o dos dados
		...
		//Op��o de encerrar o la�o
		char resposta;
		cout << "Voce deseja continuar: <S>SIM  ou <N>NAO...";
		cin >> resposta;

		//La�o de encerramento ou continua��o
		if(resposta != 's')
		{
			break;
		}
	...
	//Impress�o dos dados atribuidos a structs
	...
	//Chamando a fun��o BUBBLE SORT
	ordena(car, i);

	//Impress�o dos dados ap�s utilizar o ordenamento
